...
$query = "SELECT * FROM commmandes WHERE statut_commande != 'supprimer' ORDER BY id_commande DESC LIMIT :limit OFFSET :offset";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h2>Liste des Commandes</h2>
                <a href="" class="btn btn-danger float-end"><i class="bi bi-trash-fill"></i></a>
            </div>
        </div>
