    ...
    <?php if (isset($_GET["maintenance"])) { ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <p class="text-center"> <i class="bi bi-telephone-fill text-primary"></i> Contact Numero : 0777436709</p>
            </div>
        </div>
    ...
    <?php } else if (isset($_GET["Consultation"])) { ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                </div>  <p class="text-center"> <i class="bi bi-telephone-fill text-primary"></i> Contact Numero : 0777436709</p>
            </div>
        </div>
    <?php } ?>
